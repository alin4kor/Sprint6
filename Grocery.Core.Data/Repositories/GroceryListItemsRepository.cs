...
namespace Grocery.Core.Data.Repositories
{
    public class GroceryListItemsRepository : DatabaseConnection, IGroceryListItemsRepository
    {
        ...
        public GroceryListItemsRepository()
        {
            ...
            List<string> insertQueries = [@"INSERT OR IGNORE INTO GroceryListItem(Name, GroceryListId, ProductId, Amount) VALUES('', 1, 1, 3)",
                                          @"INSERT OR IGNORE INTO GroceryListItem(Name, GroceryListId, ProductId, Amount) VALUES('', 1, 2, 1)",
                                          @"INSERT OR IGNORE INTO GroceryListItem(Name, GroceryListId, ProductId, Amount) VALUES('', 1, 3, 4)",
                                          @"INSERT OR IGNORE INTO GroceryListItem(Name, GroceryListId, ProductId, Amount) VALUES('', 2, 1, 2)",
                                          @"INSERT OR IGNORE INTO GroceryListItem(Name, GroceryListId, ProductId, Amount) VALUES('', 2, 2, 5)"];
        ...
        {
            List<GroceryListItem> filteredListItems = [];
            ...
            using (SqliteCommand command = new(selectQuery, Connection))
            {
                ...
                while (reader.Read())
                {
                    ...
                    int productId = reader.GetInt32(2);
                    int amount = reader.GetInt32(3);
                    filteredListItems.Add(new(itemId, groceryListId, productId, amount));
                }
            }
            CloseConnection();
        ...
        {
            string insertQuery = $"INSERT INTO GroceryListItem(Name, GroceryListId, ProductId, Amount) VALUES(@Name, @GroceryListId, @ProductId, @Amount) Returning Id;";
